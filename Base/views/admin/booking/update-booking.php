            ...
            <fieldset class="mb-4 border p-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="payment_status" id="payment_status" class="form-control">
                        <option value="Pending" <?= (($booking['payment_status'] ?? '') == 'Pending') ? 'selected' : '' ?>>Pending (Chờ thanh toán)</option>
                        <option value="Paid" <?= (($booking['payment_status'] ?? '') == 'Paid') ? 'selected' : '' ?>>Paid (Đã thanh toán)</option>
                        <option value="Failed" <?= (($booking['payment_status'] ?? '') == 'Failed') ? 'selected' : '' ?>>Failed (Thanh toán thất bại)</option>
                    </select>
                </div>
            ...
            <fieldset class="mb-4 border p-3">
                ...
                <table class="table table-sm table-striped">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="4" class="text-center">Chưa có khách tham gia nào được ghi nhận.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
